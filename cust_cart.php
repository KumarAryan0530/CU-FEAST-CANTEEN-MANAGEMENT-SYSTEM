                    ...
                    <form method="POST" action="add_order.php">
                        ...
                        <div class="col">
                            ...
                            <script type="text/javascript" src="https://cdn.omise.co/omise.js"
                                ...
                                data-image="https://github.com/waterthatfrozen/CU Feast/blob/9852a00d8e47b50cbe428a7f7ec763446ac273b4/img/ICON_F.png"
                                data-frame-label="CU Feast | Chanidgarh University"
                                data-button-label="Proceed with payment"
                                data-submit-label="Submit"
                                data-locale="en"
                                data-location="no"
                                data-amount="<?php echo $order_cost*100;?>"
                                data-currency="rupees">
                            </script>
                            <?php } ?>
                        </div>
                    </form>
