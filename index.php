...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to CU Feast</h1>
            <p class="lead fw-normal">Food ordering system of Chandigarh University Campus Canteen</p>
            <span class="xsmall-font text-muted">made with love by CU Students</span>
        </div>
    </div>
    ...
    <footer
        ...
        <span class="smaller-font">&copy; 2023 Chandigarh University<br /><span class="xsmall-font">Made with love by Kumar Aryan ❤️</span></span>
        <ul class="nav justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-light" target="_blank" href="https://github.com/kumararyan0530"><i
